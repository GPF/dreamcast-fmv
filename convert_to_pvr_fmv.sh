...
# Check if .dt files already exist
if ls "$OUTPUT_DIR"/frame0000."$EXT" 1> /dev/null 2>&1; then
  echo "✅ Found existing .${EXT} files, skipping PNG extraction and texture conversion."
else
